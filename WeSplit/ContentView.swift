...
//    let tipPercentages = [0, 5, 10, 15, 20]
    ...
    /// This computed property returns the total amount to pay, including the tip.
    ...
    /// This computed property returns how much each person is going to pay, including the tip.
